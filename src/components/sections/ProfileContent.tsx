      ...
      <div className="section-container">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <ScrollReveal>
              <h3 className="font-heading font-semibold text-xl text-primary mb-4">Solotech University</h3>
              ...
              <p className="text-foreground/80 leading-relaxed mb-6">
                Dengan tagline <strong>"Technology for Transformation"</strong>, semua prodi di lingkungan UKTS mengintegrasikan teknologi ke dalam bidang-bidang ilmu yang diajarkan, termasuk di prodi-prodi di dalam Fakultas Ekonomi dan Teologi.
              </p>
            </ScrollReveal>

            <ScrollReveal>
              <h3 id="sejarah" className="font-heading font-semibold text-xl text-primary mt-8 mb-4">Sejarah Singkat</h3>
              <p className="text-foreground/80 leading-relaxed mb-6">
            ...
            <ScrollReveal>
              <h3 id="visi-misi" className="font-heading font-semibold text-xl text-primary mt-8 mb-4">Visi dan Misi</h3>
              ...
              <div className="bg-muted/50 rounded-xl p-6 mb-8 hover:shadow-lg transition-shadow">
                ...
                <ul className="space-y-2 text-foreground/80">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Menyelenggarakan pendidikan ilmu, teknologi, dan seni yang relevan untuk menghasilkan lulusan berkualitas global.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                    <span>Menyelenggarakan penelitian dengan mengembangkan budaya inovatif, proaktif, dan kolaboratif.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                    <span>Menyelenggarakan pengabdian kepada masyarakat sebagai wujud komitmen partisipasi untuk berkontribusi pada transformasi.</span>
                  </li>
                </ul>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal>
              ...
              <div className="grid md:grid-cols-3 gap-4 mb-8">
                {[
                  ...
                  <div key={faculty.name} className="bg-card border border-border rounded-xl p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300" style={{ transitionDelay: `${index * 100}ms` }}>
                    <h5 className="font-heading font-semibold text-foreground mb-2">{faculty.name}</h5>
                    <ul className="text-sm text-muted-foreground space-y-1">
                      {faculty.programs.map((program) => (<li key={program}>• {program}</li>))}
                    </ul>
                  </div>
                ))}
              </div>
            ...
            <ScrollReveal>
              <h3 id="fasilitas" className="font-heading font-semibold text-xl text-primary mt-8 mb-4">Keunggulan UKTS</h3>
              <div className="grid md:grid-cols-2 gap-4 mb-8">
                {[
                  ...
                  <div key={item.title} className="bg-card border border-border rounded-xl p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300" style={{ transitionDelay: `${index * 100}ms` }}>
                    <h5 className="font-heading font-semibold text-foreground mb-2">{item.title}</h5>
            ...
            <ScrollReveal>
              <h3 id="akreditasi" className="font-heading font-semibold text-xl text-primary mt-8 mb-4">Akreditasi & Penghargaan</h3>
              <div className="grid md:grid-cols-3 gap-4 mb-8">
                {[
                  { title: 'Akreditasi Institusi', status: 'Unggul', issuer: 'BAN-PT', desc: 'Terakreditasi dengan predikat Unggul oleh Badan Akreditasi Nasional Perguruan Tinggi' },
                  { title: 'Program Studi Teologi', status: 'Terakreditasi', issuer: 'LAM Pendidikan Agama', desc: 'S1 Pendidikan Agama Kristen dengan standar kurikulum internasional' },
                  { title: 'Program Teknik', status: 'Terakreditasi', issuer: 'ABET/IABEE', desc: 'Program Teknik Informatika dan Teknik Lingkungan dengan sertifikasi engineering' },
                  { title: 'ISO 9001:2015', status: 'Tersertifikasi', issuer: 'Badan Sertifikasi', desc: 'Sistem manajemen mutu untuk semua proses akademik dan administratif' },
                  { title: 'Green Campus', status: 'Bersertifikat', issuer: 'Kementerian LHK', desc: 'Komitmen terhadap keberlanjutan lingkungan dan pengembangan kampus hijau' },
                  { title: 'International Partnership', status: 'Aktif', issuer: 'Global Universities', desc: 'Kerjasama dengan 25+ universitas internasional di berbagai negara' },
                ].map((cert, index) => (
                  <div key={cert.title} className="bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 rounded-xl p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300" style={{ transitionDelay: `${index * 100}ms` }}>
              ...
              <p className="text-foreground/80 leading-relaxed">
                Sebagai institusi pendidikan yang terus bertransformasi, Universitas Kristen Teknologi Solo berkomitmen untuk menghasilkan lulusan yang tidak hanya kompeten secara teknis, tetapi juga memiliki karakter kuat berdasarkan nilai-nilai kristiani.
              </p>
            </ScrollReveal>
          </div>
        </div>
